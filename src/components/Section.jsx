...
const Section = ({title, company, description, image, alt, imageStyle}) => {
  return (
    <section className='group hover:bg-gray-200'>
      <div className='container mx-auto p-6 flex flex-col justify-between items-start border-black border-b-2 md:flex-row'>
        <div className='flex flex-col justify-center items-start space-y-7'>
          ...
          <p className='font-pixel text-base max-w-3xl'>
            {description}
          </p>
        </div>
