...
const Header = () => {
 ...
 const classLink = ({ isActive }) => isActive ? 'text-xl text-amber-600 uppercase hover:text-amber-500 underline lg:flex' : 'text-xl uppercase hover:text-amber-500 lg:flex';
  ...
  return (
    <header>
      <div className={`relative container mx-auto p-4 flex ${isMenuOpen ? 'flex-row-reverse justify-between items-start' : 'flex-row justify-end items-center'} font-pixel mb-2 2xl:mb-10 lg:p-6 lg:justify-center lg:space-x-10`}>
